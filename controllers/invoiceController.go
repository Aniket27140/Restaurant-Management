...
func UpdateInvoice() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		filter := bson.M{"invoice": invoiceId}
		...
		// When upsert is set to true, the UpdateOne or UpdateMany operation will create a new document if no matching document is found.
		upsert := true
