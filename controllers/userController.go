...
func Signup() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// validate the data in user struct which is coming from req.body basically all fields are there are not.
		...
		// then you insert this new user into the user collection
